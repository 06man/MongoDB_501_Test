...
Asia 지역에서 판매된 제품별로 총 판매 금액을 계산하여,
    판매 금액(totalSales)이 가장 높은 제품부터 내림차순으로 정렬됩니다.

        db.sales.insertMany([
            { product: "Laptop", region: "Asia", amount: 1200, date: ISODate("2024-02-01") },
            { product: "Laptop", region: "Europe", amount: 1500, date: ISODate("2024-02-02") },
            { product: "Laptop", region: "Asia", amount: 800, date: ISODate("2024-02-03") },
            { product: "Phone", region: "Asia", amount: 600, date: ISODate("2024-02-01") },
            { product: "Phone", region: "America", amount: 700, date: ISODate("2024-02-02") },
            { product: "Tablet", region: "Asia", amount: 900, date: ISODate("2024-02-03") },
            { product: "Tablet", region: "Europe", amount: 1100, date: ISODate("2024-02-04") },
            { product: "Tablet", region: "Asia", amount: 500, date: ISODate("2024-02-05") },
            { product: "Monitor", region: "Asia", amount: 300, date: ISODate("2024-02-06") },
            { product: "Monitor", region: "Europe", amount: 400, date: ISODate("2024-02-07") }
        ]);
...
db.salesB.aggregate([
  {
    $facet: {
      ...
      topProducts: [{ $group: { _id: "$product", sales: { $sum: "$amount" } } }, { $sort: { sales: -1 } }, { $limit: 5 }]
    }
  }
])
...
db.salesB.aggregate([{ $sample: { size: 5 } }])
